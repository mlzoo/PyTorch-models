...
for epoch in range(epochs):
    ...
    torch.save({'epoch': epoch + 1, 
               ...
               './alexnet--epoch-' + str(epoch + 1) + '--accuracy-' + str("%.4f" % max(epoch_accuracies).item()) + '.pth.tar')
    print('Model saved at', './alexnet--epoch-' + str(epoch + 1) + '--accuracy-' + str("%.4f" % max(epoch_accuracies).item()) + '.pth.tar')
